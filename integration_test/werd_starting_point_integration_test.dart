...
void main() {
  ...
  group('Werd Starting Point Integration Test', () {
    testWidgets('Starting point should stay fixed after reading more ayahs', (
      tester,
    ) async {
      final tempDir = Directory.systemTemp.createTempSync(
        'fard_starting_point_test_',
      );
      ...
      await prefs.setString(
        'werd_progress',
        '{"totalAyahsReadToday":0,"readAyahsToday":[],"sessionStartAbsolute":1,"lastUpdated":"2026-03-03T00:00:00.000","streak":0,"history":{}}',
      );
      ...
      await tester.pumpWidget(
        MaterialApp(
          ...
          onGenerateRoute: (settings) =>
              QuranReaderPage.route(surahNumber: 1, ayahNumber: 1),
        ),
      );
