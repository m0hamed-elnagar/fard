  ...
  group('Werd UX Integration Test', () {
    ...
    setUp(() async {
      ...
      await prefs.setString(
        'locale',
        'ar',
      ); // Use Arabic to match some logic if needed
    });
    ...
    testWidgets(
      'Verify green flag on first ayah of Al-Fatihah for first-time user',
      (tester) async {
    ...
    testWidgets('Verify bookmark icon appears after reading an ayah', (
      tester,
    ) async {
      await tester.pumpWidget(const QadaTrackerApp());
      await tester.pumpAndSettle();
    ...
    testWidgets('Jump to Werd navigates to first ayah if nothing read', (
      tester,
    ) async {
      await tester.pumpWidget(const QadaTrackerApp());
      await tester.pumpAndSettle();
      ...
      final jumpToWerd = find.byIcon(
        Icons.auto_awesome_outlined,
      ); // Werd jump icon in ReaderInfoBar
