...
class QuranHizbProvider {
  ...
  static const List<List<int>> _rubStarts = [
    [1, 1], [2, 26], [2, 44], [2, 60], [2, 75], [2, 92], [2, 106], [2, 124], [2, 142], [2, 158], [2, 177], [2, 189], [2, 203], [2, 219], [2, 233], [2, 243], [2, 253], [2, 263], [2, 272], [2, 283], [3, 15], [3, 33], [3, 52], [3, 75], [3, 93], [3, 113], [3, 133], [3, 153], [3, 171], [3, 186], [4, 1], [4, 12], [4, 24], [4, 36], [4, 58], [4, 74], [4, 88], [4, 100], [4, 114], [4, 135], [4, 148], [4, 163], [5, 1], [5, 12], [5, 27], [5, 41], [5, 51], [5, 67], [5, 82], [5, 97], [5, 109], [6, 13], [6, 36], [6, 59], [6, 74], [6, 95], [6, 111], [6, 127], [6, 141], [6, 151], [7, 1], [7, 31], [7, 47], [7, 65], [7, 88], [7, 117], [7, 142], [7, 156], [7, 171], [7, 189], [8, 1], [8, 22], [8, 41], [8, 61], [9, 1], [9, 19], [9, 34], [9, 60], [9, 75], [9, 93], [9, 111], [10, 1], [10, 26], [10, 53], [10, 71], [10, 90], [11, 6], [11, 24], [11, 41], [11, 61], [11, 84], [11, 108], [12, 1], [12, 30], [12, 53], [12, 77], [12, 101], [13, 5], [13, 19], [13, 35], [14, 1], [14, 28], [14, 53], [15, 49], [16, 1], [16, 30], [16, 51], [16, 75], [16, 90], [16, 111], [17, 1], [17, 23], [17, 50], [17, 70], [17, 99], [18, 17], [18, 32], [18, 51], [18, 75], [18, 99], [19, 22], [19, 59], [20, 1], [20, 55], [20, 83], [20, 111], [21, 1], [21, 29], [21, 51], [21, 83], [22, 1], [22, 19], [22, 38], [22, 60], [23, 1], [23, 36], [23, 75], [24, 1], [24, 21], [24, 35], [24, 53], [25, 1], [25, 21], [25, 53], [26, 1], [26, 52], [26, 111], [26, 160], [27, 1], [27, 27], [27, 56], [27, 82], [28, 1], [28, 29], [28, 51], [28, 76], [29, 1], [29, 26], [29, 46], [30, 1], [30, 31], [30, 54], [31, 22], [32, 11], [33, 1], [33, 18], [33, 31], [33, 51], [33, 60], [34, 1], [34, 24], [34, 46], [35, 15], [36, 1], [36, 28], [36, 60], [37, 1], [37, 83], [37, 145], [38, 21], [38, 52], [39, 1], [39, 32], [39, 53], [39, 75], [40, 21], [40, 41], [40, 66], [41, 1], [41, 25], [41, 47], [42, 13], [42, 27], [42, 51], [43, 24], [43, 57], [44, 17], [45, 1], [46, 1], [46, 21], [47, 1], [47, 19], [48, 1], [48, 18], [49, 1], [49, 14], [50, 27], [51, 31], [52, 24], [53, 26], [54, 9], [55, 1], [56, 1], [56, 75], [57, 1], [57, 16], [58, 1], [58, 14], [59, 11], [60, 1], [61, 1], [62, 1], [64, 1], [65, 1], [66, 1], [67, 1], [68, 1], [69, 1], [70, 1], [71, 1], [73, 1], [74, 1], [76, 1], [77, 1], [79, 1], [81, 1], [85, 1], [88, 1], [94, 1]
  ];
  ...
  static int getHizbNumber(int surahNumber, int ayahNumber) {
    for (int i = _hizbStarts.length - 1; i >= 0; i--) {
      if (surahNumber > _hizbStarts[i][0] || (surahNumber == _hizbStarts[i][0] && ayahNumber >= _hizbStarts[i][1])) {
        return i + 1;
      }
    }
    return 1;
  ...
  static int getRubNumber(int surah, int ayah) {
    for (int i = _rubStarts.length - 1; i >= 0; i--) {
      if (surah > _rubStarts[i][0] || (surah == _rubStarts[i][0] && ayah >= _rubStarts[i][1])) {
        return i + 1;
      }
    }
    return 1;
  ...
  static int _getLastAyahOfPage(int page) {
    ...
    for (int s = 1; s <= 114; s++) {
      for (int v = 1; v <= quran.getVerseCount(s); v++) {
        if (quran.getPageNumber(s, v) > page) return getAbsoluteAyahNumber(s, v) - 1;
      }
    }
    return 6236;
  }
  ...
  static double calculateFractionalProgress(Set<int> readItems, WerdUnit unit) {
    ...
    return unit == WerdUnit.page ? totalProgress.clamp(0.0, 604.0) : totalProgress.clamp(0.0, 30.0);
  }
