                  ...
                  children: [
                    ReaderInfoBar(
                      ...
                      bookmarkAbsolutes:
                          s.bookmarks
                              .where(
                                (b) => b.ayahNumber.surahNumber == surahNumber,
                              )
                              .map(
                                (b) => QuranHizbProvider.getAbsoluteAyahNumber(
                      ...
                      onJumpToBookmark: () {
                        final surahBookmarks =
                            s.bookmarks
                                .where(
                                  (b) =>
                                      b.ayahNumber.surahNumber == surahNumber,
                                )
                                .toList()
                              ..sort(
                                (a, b) => a.ayahNumber.ayahNumberInSurah
                                    .compareTo(b.ayahNumber.ayahNumberInSurah),
                              );
                        ...
                        final nextBookmark = surahBookmarks.firstWhere(
                          (b) =>
                              b.ayahNumber.ayahNumberInSurah > currentAyahNum,
                        ...
                        try {
                          final ayah = s.surah.ayahs.firstWhere(
                            (a) =>
                                ...
                                nextBookmark.ayahNumber.ayahNumberInSurah,
                          );
                          context.read<ReaderBloc>().add(
                            ReaderEvent.selectAyah(ayah),
                          );
                        } catch (_) {}
                        scrollController.scrollToAyah(
                          nextBookmark.ayahNumber.ayahNumberInSurah,
                        );
                      },
                    ),
                    AudioPlayerBar(
                      ...
                      onScrollRequest: (s, a) =>
                          scrollController.scrollToAyah(a),
                    ),
                  ],
                );
              },
