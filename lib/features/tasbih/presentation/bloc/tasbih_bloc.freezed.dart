...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _LoadData value)?  loadData,TResult Function( _SelectCategory value)?  selectCategory,TResult Function( _Increment value)?  increment,TResult Function( _Reset value)?  reset,TResult Function( _ToggleSound value)?  toggleSound,TResult Function( _ToggleVibration value)?  toggleVibration,TResult Function( _ToggleTranslation value)?  toggleTranslation,TResult Function( _ToggleTransliteration value)?  toggleTransliteration,TResult Function( _SelectCompletionDua value)?  selectCompletionDua,TResult Function( _RememberCompletionDua value)?  rememberCompletionDua,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return rememberCompletionDua(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _LoadData value)  loadData,required TResult Function( _SelectCategory value)  selectCategory,required TResult Function( _Increment value)  increment,required TResult Function( _Reset value)  reset,required TResult Function( _ToggleSound value)  toggleSound,required TResult Function( _ToggleVibration value)  toggleVibration,required TResult Function( _ToggleTranslation value)  toggleTranslation,required TResult Function( _ToggleTransliteration value)  toggleTransliteration,required TResult Function( _SelectCompletionDua value)  selectCompletionDua,required TResult Function( _RememberCompletionDua value)  rememberCompletionDua,}){
final _that = this;
switch (_that) {
case _LoadData():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _LoadData value)?  loadData,TResult? Function( _SelectCategory value)?  selectCategory,TResult? Function( _Increment value)?  increment,TResult? Function( _Reset value)?  reset,TResult? Function( _ToggleSound value)?  toggleSound,TResult? Function( _ToggleVibration value)?  toggleVibration,TResult? Function( _ToggleTranslation value)?  toggleTranslation,TResult? Function( _ToggleTransliteration value)?  toggleTransliteration,TResult? Function( _SelectCompletionDua value)?  selectCompletionDua,TResult? Function( _RememberCompletionDua value)?  rememberCompletionDua,}){
final _that = this;
switch (_that) {
case _LoadData() when loadData != null:
return loadData(_that);case _SelectCategory() when selectCategory != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loadData,TResult Function( String categoryId)?  selectCategory,TResult Function()?  increment,TResult Function()?  reset,TResult Function()?  toggleSound,TResult Function()?  toggleVibration,TResult Function()?  toggleTranslation,TResult Function()?  toggleTransliteration,TResult Function( String duaId)?  selectCompletionDua,TResult Function()?  rememberCompletionDua,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoadData() when loadData != null:
...
return rememberCompletionDua();case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loadData,required TResult Function( String categoryId)  selectCategory,required TResult Function()  increment,required TResult Function()  reset,required TResult Function()  toggleSound,required TResult Function()  toggleVibration,required TResult Function()  toggleTranslation,required TResult Function()  toggleTransliteration,required TResult Function( String duaId)  selectCompletionDua,required TResult Function()  rememberCompletionDua,}) {final _that = this;
switch (_that) {
case _LoadData():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loadData,TResult? Function( String categoryId)?  selectCategory,TResult? Function()?  increment,TResult? Function()?  reset,TResult? Function()?  toggleSound,TResult? Function()?  toggleVibration,TResult? Function()?  toggleTranslation,TResult? Function()?  toggleTransliteration,TResult? Function( String duaId)?  selectCompletionDua,TResult? Function()?  rememberCompletionDua,}) {final _that = this;
switch (_that) {
case _LoadData() when loadData != null:
return loadData();case _SelectCategory() when selectCategory != null:
return selectCategory(_that.categoryId);case _Increment() when increment != null:
...
mixin _$TasbihState {
 ...
 TasbihData get data; TasbihCategory get currentCategory; CompletionDua? get currentCompletionDua; int get totalCount; int get currentCycleCount; int get currentCycleIndex; bool get showCompletionDua; bool get isLoading; String? get error; bool get duaRemembered;
...
@useResult
$Res call({
 TasbihData data, TasbihCategory currentCategory, CompletionDua? currentCompletionDua, int totalCount, int currentCycleCount, int currentCycleIndex, bool showCompletionDua, bool isLoading, String? error, bool duaRemembered
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TasbihData data,  TasbihCategory currentCategory,  CompletionDua? currentCompletionDua,  int totalCount,  int currentCycleCount,  int currentCycleIndex,  bool showCompletionDua,  bool isLoading,  String? error,  bool duaRemembered)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TasbihState() when $default != null:
return $default(_that.data,_that.currentCategory,_that.currentCompletionDua,_that.totalCount,_that.currentCycleCount,_that.currentCycleIndex,_that.showCompletionDua,_that.isLoading,_that.error,_that.duaRemembered);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( TasbihData data,  TasbihCategory currentCategory,  CompletionDua? currentCompletionDua,  int totalCount,  int currentCycleCount,  int currentCycleIndex,  bool showCompletionDua,  bool isLoading,  String? error,  bool duaRemembered)  $default,) {final _that = this;
switch (_that) {
case _TasbihState():
return $default(_that.data,_that.currentCategory,_that.currentCompletionDua,_that.totalCount,_that.currentCycleCount,_that.currentCycleIndex,_that.showCompletionDua,_that.isLoading,_that.error,_that.duaRemembered);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( TasbihData data,  TasbihCategory currentCategory,  CompletionDua? currentCompletionDua,  int totalCount,  int currentCycleCount,  int currentCycleIndex,  bool showCompletionDua,  bool isLoading,  String? error,  bool duaRemembered)?  $default,) {final _that = this;
switch (_that) {
case _TasbihState() when $default != null:
return $default(_that.data,_that.currentCategory,_that.currentCompletionDua,_that.totalCount,_that.currentCycleCount,_that.currentCycleIndex,_that.showCompletionDua,_that.isLoading,_that.error,_that.duaRemembered);case _:
  return null;
...
class _TasbihState implements TasbihState {
  const _TasbihState({required this.data, required this.currentCategory, this.currentCompletionDua, this.totalCount = 0, this.currentCycleCount = 0, this.currentCycleIndex = 0, this.showCompletionDua = false, this.isLoading = false, this.error, this.duaRemembered = false});
