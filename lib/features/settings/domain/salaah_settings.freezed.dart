...
mixin _$SalaahSettings {
 ...
 Salaah get salaah; bool get isAzanEnabled; bool get isReminderEnabled; int get reminderMinutesBefore; bool get isAfterSalahAzkarEnabled; String? get azanSound;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,salaah,isAzanEnabled,isReminderEnabled,reminderMinutesBefore,isAfterSalahAzkarEnabled,azanSound);

@override
String toString() {
  return 'SalaahSettings(salaah: $salaah, isAzanEnabled: $isAzanEnabled, isReminderEnabled: $isReminderEnabled, reminderMinutesBefore: $reminderMinutesBefore, isAfterSalahAzkarEnabled: $isAfterSalahAzkarEnabled, azanSound: $azanSound)';
}
...
@useResult
$Res call({
 Salaah salaah, bool isAzanEnabled, bool isReminderEnabled, int reminderMinutesBefore, bool isAfterSalahAzkarEnabled, String? azanSound
});
...
/// Create a copy of SalaahSettings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? salaah = null,Object? isAzanEnabled = null,Object? isReminderEnabled = null,Object? reminderMinutesBefore = null,Object? isAfterSalahAzkarEnabled = null,Object? azanSound = freezed,}) {
...
as bool,azanSound: freezed == azanSound ? _self.azanSound : azanSound // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Salaah salaah,  bool isAzanEnabled,  bool isReminderEnabled,  int reminderMinutesBefore,  bool isAfterSalahAzkarEnabled,  String? azanSound)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SalaahSettings() when $default != null:
return $default(_that.salaah,_that.isAzanEnabled,_that.isReminderEnabled,_that.reminderMinutesBefore,_that.isAfterSalahAzkarEnabled,_that.azanSound);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Salaah salaah,  bool isAzanEnabled,  bool isReminderEnabled,  int reminderMinutesBefore,  bool isAfterSalahAzkarEnabled,  String? azanSound)  $default,) {final _that = this;
switch (_that) {
case _SalaahSettings():
return $default(_that.salaah,_that.isAzanEnabled,_that.isReminderEnabled,_that.reminderMinutesBefore,_that.isAfterSalahAzkarEnabled,_that.azanSound);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Salaah salaah,  bool isAzanEnabled,  bool isReminderEnabled,  int reminderMinutesBefore,  bool isAfterSalahAzkarEnabled,  String? azanSound)?  $default,) {final _that = this;
switch (_that) {
case _SalaahSettings() when $default != null:
return $default(_that.salaah,_that.isAzanEnabled,_that.isReminderEnabled,_that.reminderMinutesBefore,_that.isAfterSalahAzkarEnabled,_that.azanSound);case _:
  return null;
...
class _SalaahSettings implements SalaahSettings {
  const _SalaahSettings({required this.salaah, this.isAzanEnabled = true, this.isReminderEnabled = true, this.reminderMinutesBefore = 15, this.isAfterSalahAzkarEnabled = false, this.azanSound});
...
/// Create a copy of SalaahSettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? salaah = null,Object? isAzanEnabled = null,Object? isReminderEnabled = null,Object? reminderMinutesBefore = null,Object? isAfterSalahAzkarEnabled = null,Object? azanSound = freezed,}) {
