...
@override
int get hashCode => Object.hash(runtimeType,locale,latitude,longitude,cityName,calculationMethod,madhab,morningAzkarTime,eveningAzkarTime,isAfterSalahAzkarEnabled,const DeepCollectionEquality().hash(reminders),const DeepCollectionEquality().hash(salaahSettings),isAzanVoiceDownloading);
...
@useResult
$Res call({
 Locale locale, double? latitude, double? longitude, String? cityName, String calculationMethod, String madhab, String morningAzkarTime, String eveningAzkarTime, bool isAfterSalahAzkarEnabled, List<AzkarReminder> reminders, List<SalaahSettings> salaahSettings, bool isAzanVoiceDownloading
});
...
switch (_that) {
case _SettingsState() when $default != null:
return $default(_that.locale,_that.latitude,_that.longitude,_that.cityName,_that.calculationMethod,_that.madhab,_that.morningAzkarTime,_that.eveningAzkarTime,_that.isAfterSalahAzkarEnabled,_that.reminders,_that.salaahSettings,_that.isAzanVoiceDownloading);case _:
  return orElse();
...
switch (_that) {
case _SettingsState():
return $default(_that.locale,_that.latitude,_that.longitude,_that.cityName,_that.calculationMethod,_that.madhab,_that.morningAzkarTime,_that.eveningAzkarTime,_that.isAfterSalahAzkarEnabled,_that.reminders,_that.salaahSettings,_that.isAzanVoiceDownloading);}
}
...
@override
int get hashCode => Object.hash(runtimeType,locale,latitude,longitude,cityName,calculationMethod,madhab,morningAzkarTime,eveningAzkarTime,isAfterSalahAzkarEnabled,const DeepCollectionEquality().hash(_reminders),const DeepCollectionEquality().hash(_salaahSettings),isAzanVoiceDownloading);
