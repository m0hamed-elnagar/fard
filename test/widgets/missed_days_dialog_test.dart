  ...
  group('MissedDaysDialog', () {
    ...
    Widget createWidgetUnderTest({
      ...
      return MaterialApp(
        ...
        locale: locale,
        home: Scaffold(
          body: MissedDaysDialog(missedDates: dates, onResponse: onResponse),
        ),
      );
    }

    testWidgets('displays missed dates as calendar items', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        createWidgetUnderTest(dates: missedDates, onResponse: (_) {}),
      );
    ...
    testWidgets('LTR Swipe: Swiping right toggles multiple items', (
      WidgetTester tester,
    ) async {
      ...
      await tester.dragFrom(
        ...
        tester.getCenter(third) - tester.getCenter(first),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('RTL Swipe: Swiping left toggles multiple items', (
      WidgetTester tester,
    ) async {
      List<DateTime>? selected;
      await tester.pumpWidget(
