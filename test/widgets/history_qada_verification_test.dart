...
void main() {
  ...
  testWidgets('HistoryList shows qada completion count when qada is prayed', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('HistoryList shows both missed today and qada completed', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('HistoryList shows 0 missed if all prayers are completed', (
    WidgetTester tester,
  ) async {
    final record = DailyRecord(
      id: 'test',
