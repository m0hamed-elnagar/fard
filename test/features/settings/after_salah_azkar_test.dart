...
void main() {
  ...
  group('After Salah Azkar Feature', () {
    test(
      'toggleAfterSalahAzkar updates global and individual settings',
      () async {
    ...
    test(
      'updateSalaahSettings can override individual after salah azkar setting',
      () {
        ...
        expect(
          cubit.state.salaahSettings.first.isAfterSalahAzkarEnabled,
          false,
        );
