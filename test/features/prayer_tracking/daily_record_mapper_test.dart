...
void main() {
  group('DailyRecordMapper', () {
    ...
    final record = DailyRecord(
      ...
      completedQada: {Salaah.fajr: 2, Salaah.maghrib: 1},
    );
    ...
    test('should map domain model to entity correctly', () {
      ...
      expect(
        entity.missedIndices,
        containsAll([Salaah.fajr.index, Salaah.dhuhr.index]),
      );
    ...
    test('should map entity to domain model correctly', () {
      final entity = DailyRecordEntity(
        ...
        qadaValues: {Salaah.fajr.index: 10, Salaah.dhuhr.index: 5},
        completedQadaValues: {Salaah.fajr.index: 2, Salaah.maghrib.index: 1},
      );
    ...
    test(
      'should handle null optional fields in entity when mapping to domain',
      () {
        final entity = DailyRecordEntity(
          id: '2026-02-26',
          dateMillis: date.millisecondsSinceEpoch,
