...
void main() {
  group('Bug: Changing goal clears history', () {
    test(
      'BUG001 - setGoal resets progress but leaves segmentsToday inconsistent',
      () {
        ...
        final readItemsForCalc =
            updatedProgress.readItemsToday.isNotEmpty == true
        ...
        print(
          '   Using readItems from segments: ${readItemsForCalc.length} items',
        );
    ...
    test(
      'BUG002 - setGoal should preserve history but reset today sessions',
      () {
    ...
    test(
      'BUG003 - Verify the actual bug: Opening history shows 0 pages/juz',
      () {
        ...
        print(
          '   Using readItemsToday: ${progress.readItemsToday.length} items',
        );
    ...
    test('BUG004 - After setGoal fix, history should include today\'s reading', () {
      ...
      print(
        '   Today saved to history: ${newProgress.history.containsKey(dateKey)}',
      );
      ...
      print(
        '   History shows: ${savedEntry.totalAyahsRead} ayahs, ${savedEntry.pagesRead} pages',
      );
    });
  });
}
