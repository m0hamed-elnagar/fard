...
void main() {
  group('Percentage Consistency Across Units', () {
    test('U001 - Same reading should show same percentage in all units', () {
      ...
      print(
        '   Page goal: $pageGoal pages → ${pagePercentage.toStringAsFixed(1)}%',
      );
    ...
    test('U005 - Percentage consistency with real-world goal scenarios', () {
      ...
      print('');
      print(
        '   If goal = 30 ayahs: ${(ayahProgress / 30 * 100).toStringAsFixed(1)}%',
      );
      print(
        '   If goal = 2 pages (~$pageGoal ayahs): ${(pageProgress / 2 * 100).toStringAsFixed(1)}%',
      );
      print(
        '   If goal = 1 juz (~$juzGoal ayahs): ${(juzProgress / 1 * 100).toStringAsFixed(1)}%',
      );
    ...
    test('U009 - Percentage calculation matches UI _convertValue logic', () {
      ...
      print('');
      print(
        '   Ayah: $displayCurrentAyah / $displayTotalAyah = ${(percentAyah * 100).toStringAsFixed(1)}%',
      );
      print(
        '   Page: $displayCurrentPage / $displayTotalPage = ${(percentPage * 100).toStringAsFixed(1)}%',
      );
      print(
        '   Juz:  $displayCurrentJuz / $displayTotalJuz = ${(percentJuz * 100).toStringAsFixed(1)}%',
      );
