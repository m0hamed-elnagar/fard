      ...
      verify: (_) {
        ...
        if (captured.isNotEmpty) {
          ...
          if (finalProgress.segmentsToday.length == 3) {
            ...
            print(
              '❌ FAILURE: Expected 3 sessions, got ${finalProgress.segmentsToday.length}',
            );
            print('');
            ...
            for (var i = 0; i < finalProgress.segmentsToday.length; i++) {
              final seg = finalProgress.segmentsToday[i];
              print(
                '  Session $i: ${seg.startAyah}-${seg.endAyah} (${seg.ayahsCount} ayahs)',
              );
            }
          }
        }
        ...
        expect(
          finalProgress.segmentsToday[1].ayahsCount,
          3,
          reason: 'Session 2 should have 3 ayahs (4-6)',
        );
        expect(
          finalProgress.segmentsToday[2].ayahsCount,
          4,
