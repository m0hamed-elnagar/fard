...
void main() {
  ...
  group('SESSION TRACKING - Real Repository Integration Tests', () {
    ...
    test('REAL TEST 1: Three Continue sessions saved and loaded', () async {
      print('');
      print('╔════════════════════════════════════════════════════╗');
      ...
      final savedProgressResult = await werdRepository.getProgress(
        goalId: 'default',
      );

      expect(
        savedProgressResult.isSuccess,
        true,
        reason: 'Should load progress',
      );
      ...
      // VERIFICATIONS
      expect(
        actualProgress.segmentsToday.length,
        3,
        reason: 'Should have EXACTLY 3 sessions',
      );
      expect(
        actualProgress.totalAmountReadToday,
        9,
    ...
    test('REAL TEST 2: Big jump with "Mark All"', () async {
      print('');
      print('╔════════════════════════════════════════════════════╗');
    ...
    test('REAL TEST 3: Multiple jumps - sessions NOT merged', () async {
      print('');
      print('╔════════════════════════════════════════════════════╗');
      ...
      for (var i = 0; i < actualProgress.segmentsToday.length; i++) {
        expect(
          actualProgress.segmentsToday[i].startTime,
          isNotNull,
          reason: 'Session $i should have startTime',
        );
        expect(
          actualProgress.segmentsToday[i].endTime,
          isNotNull,
